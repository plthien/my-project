    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Create New Customer</h6>
            </nav>
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        ...
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="date" class="form-control" name="input-birthday" id="validationTooltip02"
                                   required value="${customer.getBirthday()}">
                        </div>
                        <div class="col-md-2 position-relative">
                            ...
                            <select class="form-select" id="validationTooltip03" name="input-gender" required>
                                <option value="Male" <c:if test="${customer.getGender()=='Male'}">selected</c:if>>Male
                                </option>
                                <option value="Female" <c:if test="${customer.getGender()=='Female'}">selected</c:if>>
                                    Female
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-personal-id" id="validationTooltip04"
                                   required value="${customer.getPersonalID()}">
                            <div class="text-danger">
                                ${personalIDMess}
                            </div>
                        </div>
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-phone-number" id="validationTooltip05"
                                   required value="${customer.getPhoneNumber()}">
                            <div class="text-danger">
                                ${phoneNumberMess}
                            </div>
                        </div>
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-address" id="validationTooltip06"
                                   required value="${customer.getAddress()}">
                        </div>
                        <div class="col-md-3 position-relative">
                            <label for="validationTooltip07" class="form-label">Customer Type</label>
                            <select class="form-select" name="input-customerType" id="validationTooltip07" required>
                                <c:forEach var="customerType" items="${customerTypeList}">
                                    <option value="${customerType.getId()}"
                                            <c:if test="${customer.getCustomerType().getId()==customerType.getId()}">selected</c:if>>${customerType.getName()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-md-3 position-relative">
