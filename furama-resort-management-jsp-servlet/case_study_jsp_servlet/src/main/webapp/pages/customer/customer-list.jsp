    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12 text-end ">
                <a href="/customers?userAction=create" class="text-secondary font-weight-bold text-xs badge badge-sm bg-gradient-light" data-toggle="tooltip" data-original-title="Add Employee">
                    Add new Customer
                </a>
            </div>
        </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0 " id="customerTable" >
                                ...
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder p-2 text-center ">Customer Type</th>
                                ...
                                <c:forEach var="customer" items="${customerList}">
                                    <tr>
                                        <td class="align-middle p-3">
                                            <span class="text-secondary text-xs font-weight-bold">${customer.getId()}</span>
                                        </td>
                                        <td class="p-2">
                                            <div class="d-flex">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">${customer.getName()}</h6>
                                                    <p class="text-xs text-secondary mb-0">${customer.getEmail()}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${customer.getBirthday()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${customer.getGender()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${customer.getPersonalID()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${customer.getPhoneNumber()}</span>
                                        </td>
                                        <td class="align-middle p-2">
                                            <span class="text-secondary text-xs font-weight-bold">${customer.getAddress()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${customer.getCustomerType().getName()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <a href="/customers?userAction=edit&id=${customer.getId()}" class="text-secondary font-weight-bold text-xs badge badge-sm bg-gradient-light" data-toggle="tooltip" data-original-title="Edit Customer">
                                                Edit
                                            </a>
                                            <a href="/customers?userAction=delete&id=${customer.getId()}" onclick="return confirm('Do you want to delete ${customer.getName()} ?')" class="text-secondary font-weight-bold text-xs badge badge-sm bg-gradient-light" data-toggle="tooltip" data-original-title="Delete Customer">
                                                Delete
                                            </a>
                                        </td>
                                    </tr>
