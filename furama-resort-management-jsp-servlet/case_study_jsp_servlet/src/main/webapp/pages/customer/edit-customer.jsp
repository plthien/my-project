    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Edit Customer</h6>
            </nav>
                        ...
                        <c:forEach var="customer" items="${customerList}">
                            ...
                            <div class="col-md-2 position-relative">
                                ...
                                <select class="form-select" id="validationTooltip03" name="input-gender" required>
                                    <option value="Male" <c:if test="${customer.getGender()=='Male'}"> selected </c:if>>
                                        Male
                                    </option>
                                    <option value="Female" <c:if
                                            test="${customer.getGender()=='Female'}"> selected </c:if>>Female
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-2 position-relative">
                            ...
                            <div class="col-md-3 position-relative">
                                ...
                                <select class="form-select" name="input-customerType" id="validationTooltip07" required>
                                    <c:forEach var="customerType" items="${customerTypeList}">
                                        <option value="${customerType.getId()}" <c:if
                                                test="${customer.getCustomerType().getId()==customerType.getId()}"> selected </c:if>>${customerType.getName()}</option>
                                    </c:forEach>
                                </select>
