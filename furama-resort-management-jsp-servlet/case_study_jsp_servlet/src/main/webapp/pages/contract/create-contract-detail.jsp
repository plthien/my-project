    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Create New Contract Detail</h6>
            </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Contract Detail Information</h6>
                    </div>
                    <form class="row g-3 needs-validation m-3" method="post">
                        <div class="col-md-1 position-relative">
                            <label for="validationTooltip00" class="form-label">ID Contract</label>
                            <input type="text" class="form-control" name="inputIDContract" id="validationTooltip00"
                                   value="${idContract}" readonly>
                        </div>
                        <div class="col-md-4 position-relative">
                            <label for="validationTooltip01" class="form-label">Extra Service</label>
                            <select class="form-select" name="inputIDExtraService" id="validationTooltip01" required>
                                <c:forEach var="extraService" items="${extraServiceList}">
                                    <option value="${extraService.getId()}">${extraService.getName()}&ensp;&ensp;-&ensp;&ensp;${extraService.getUnit()}&ensp;&ensp;-&ensp;&ensp;${extraService.getPrice()}</option>
                                </c:forEach>
                            </select>
                        ...
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="text" class="form-control" name="inputQuantity" id="validationTooltip02"
                                   required>
                        </div>
                        <div class="col-12">
