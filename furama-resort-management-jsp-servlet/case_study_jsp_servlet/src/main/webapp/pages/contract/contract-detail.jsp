    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Contract Detail</h6>
            </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>ID Contract: ${idContract} </h6>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0 " id="contractDetailTable">
                                <thead>
                                <tr>
                                ...
                                <c:forEach var="contractDetail" items="${contractDetailList}">
                                    <tr>
                                        <td class="align-middle p-3 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contractDetail.getId()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center" id="extraServiceName">
                                            <span class="text-secondary text-xs font-weight-bold">${contractDetail.getExtraService().getName()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contractDetail.getExtraService().getUnit()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contractDetail.getExtraService().getPrice()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contractDetail.getQuantity()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contractDetail.getTotal()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <a href="/contracts?userAction=deleteContractDetail&id=${contractDetail.getId()}"
                                               onclick="return confirm('Do you want to delete ${contractDetail.getId()} ?')"
