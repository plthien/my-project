            ...
            <li class="nav-item">
                <a class="nav-link  " href="/home">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 45 40" version="1.1"
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    ...
                    <%--                        <input id="searchContract" name="searchName" type="text" class="form-control" placeholder="Type name...">--%>
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        ...
                        <c:forEach var="contract" items="${contractList}">
                            <div class="col-md-1 position-relative">
                                <label for="validationTooltip07" class="form-label">ID Contract</label>
                                <input type="text" class="form-control" name="inputIDContract" id="validationTooltip07"
                                       value="${contract.getId()}" readonly>
                            </div>
                            <div class="col-md-3 position-relative">
                                <label for="validationTooltip00" class="form-label">Customer</label>
                                <select class="form-select" name="inputIdCustomer" id="validationTooltip00" required>
                                    <c:forEach var="customer" items="${customerList}">
                                        <option value="${customer.getId()}" <c:if
                                                test="${contract.getCustomer().getId()==customer.getId()}"> selected </c:if>>${customer.getId()}
                            ...
                            <div class="col-md-4 position-relative">
                                <label for="validationTooltip01" class="form-label">Facility</label>
                                <select class="form-select" name="inputIdFacility" id="validationTooltip01" required>
                                    <c:forEach var="facility" items="${facilityList}">
                                        <option value="${facility.getId()}" <c:if
                                                test="${contract.getFacility().getId()==facility.getId()}"> selected </c:if>>${facility.getId()}
                                            - ${facility.getName()}</option>
                                    </c:forEach>
                                </select>
                                <div class="invalid-tooltip">
                                    Please select a valid state.
                            ...
                            <div class="col-md-2 position-relative">
                                ...
                                <input type="date" class="form-control" name="inputCheckinDate" id="validationTooltip02"
                                       value="${contract.getCheckInDate()}" required>
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip03" class="form-label">Checkout Date</label>
                                <input type="date" class="form-control" name="inputCheckoutDate"
                                       id="validationTooltip03" value="${contract.getCheckOutDate()}" required>
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip04" class="form-label">Deposit</label>
                                <input type="text" class="form-control" name="inputDeposit" id="validationTooltip04"
                                       value="${contract.getDeposit()}" required>
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip05" class="form-label">Payment</label>
                                <input type="text" class="form-control" name="inputPayment" id="validationTooltip05"
                                       value="${contract.getPayment()}" required>
                            </div>
                            <div class="col-md-3 position-relative">
                                <label for="validationTooltip06" class="form-label">Employee</label>
                                <select class="form-select" name="inputIdEmployee" id="validationTooltip06" required>
                                    <c:forEach var="employee" items="${employeeList}">
                                        <option value="${employee.getId()}" <c:if
                                                test="${contract.getEmployee().getId()==employee.getId()}"> selected </c:if>>${employee.getId()}
