        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Contracts</li>
                </ol>
    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12 text-end ">
                <a href="/contracts?userAction=create"
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0 " id="contractTable">
                                <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder p-3 ">ID
                                        Contract
                                    </th>
                                ...
                                <c:forEach var="contract" items="${contractList}">
                                    <tr>
                                        <td class="align-middle p-3 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contract.getId()}</span>
                                        </td>
                                        <td class="align-middle p-2">
                                            <a href="/customers?userAction=search&searchName=${contract.getCustomer().getId()}"><span
                                                    class="text-secondary text-xs font-weight-bold">${contract.getCustomer().getName()}</span></a>
                                        </td>
                                        <td class="p-2">
                                            <div class="d-flex">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="/facilities?userAction=search&searchName=${contract.getFacility().getId()}">
                                                        <h6 class="mb-0 text-sm">${contract.getFacility().getId()}</h6>
                                                        <p class="text-xs text-secondary mb-0">${contract.getFacility().getName()}</p>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contract.getCheckInDate()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contract.getCheckOutDate()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contract.getDeposit()}</span>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <span class="text-secondary text-xs font-weight-bold">${contract.getPayment()}</span>
                                        </td>
                                        <td class="align-middle p-2">
                                        ...
                                        <td class="align-middle p-2">
                                            <a href="/employees?userAction=search&searchName=${contract.getEmployee().getId()}"><span class="text-secondary text-xs font-weight-bold">${contract.getEmployee().getName()}</span></a>
                                        </td>
                                        <td class="align-middle p-2 text-center">
                                            <a href="/contracts?userAction=edit&id=${contract.getId()}"
                                               class="text-secondary font-weight-bold text-xs badge badge-sm bg-gradient-light"
                                            ...
                                            <a href="/contracts?userAction=delete&id=${contract.getId()}"
                                               ...
                                               class="text-secondary font-weight-bold text-xs badge badge-sm bg-gradient-light"
                                               data-toggle="tooltip" data-original-title="Delete Employee">
                                                Delete
                                            </a>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    const dataTableBasic = new simpleDatatables.DataTable("#contractTable", {
        searchable: false,
        fixedHeight: true,
        sortable: false,
