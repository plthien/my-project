    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Create New Contract</h6>
            </nav>
                ...
                <div class="card mb-4">
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        ...
                        <div class="col-md-4 position-relative">
                            ...
                            <select class="form-select" name="inputIdFacility" id="validationTooltip01" required>
                                <c:forEach var="facility" items="${facilityList}">
                                    <option value="${facility.getId()}">${facility.getId()}
                        ...
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="date" class="form-control" name="inputCheckoutDate" id="validationTooltip03"
                                   required>
                        </div>
                        <div class="col-md-2 position-relative">
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <select class="form-select" name="inputIdEmployee" id="validationTooltip06" required>
                                <c:forEach var="employee" items="${employeeList}">
                                    <option value="${employee.getId()}">${employee.getId()}
