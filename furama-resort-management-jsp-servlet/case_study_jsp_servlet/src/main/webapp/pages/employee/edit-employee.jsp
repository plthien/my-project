    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Edit Employee</h6>
            </nav>
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <%--                    <form class="input-group m-0" method="post" action="/employees?userAction=search">--%>
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        <c:forEach var="employee" items="${employeeList}">
                            ...
                            <div class="col-md-2 position-relative">
                                ...
                                <input type="date" class="form-control" name="input-birthday" id="validationTooltip02"
                                       required
                            ...
                            <div class="col-md-2 position-relative">
                                ...
                                <select class="form-select" id="validationTooltip03" name="input-gender" required>
                                    <option value="Male" <c:if test="${employee.getGender()=='Male'}"> selected </c:if>>
                                        Male
                                    </option>
                                    <option value="Female" <c:if
                                            test="${employee.getGender()=='Female'}"> selected </c:if>>Female
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip04" class="form-label">Personal ID</label>
                                <input type="text" class="form-control" name="input-personal-id"
                            ...
                            <div class="col-md-2 position-relative">
                                ...
                                <input type="text" class="form-control" name="input-phone-number"
                            ...
                            <div class="col-md-4 position-relative">
                                ...
                                <input type="text" class="form-control" name="input-address" id="validationTooltip06"
                                       required
                            ...
                            <div class="col-md-2 position-relative">
                                ...
                                <select class="form-select" name="input-degree" id="validationTooltip07" required>
                                    <c:forEach var="degree" items="${employeeDegreeList}">
                                        <option value="${degree.getId()}" <c:if
                                                test="${employee.getEmployeeDegree().getId()==degree.getId()}"> selected </c:if>>${degree.getName()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="col-md-2 position-relative">
                                ...
                                <select class="form-select" name="input-office" id="validationTooltip08" required>
                                    <c:forEach var="office" items="${employeeOfficeList}">
                                        <option value="${office.getId()}" <c:if
                                                test="${employee.getEmployeeOffice().getId()==office.getId()}"> selected </c:if>>${office.getName()}</option>
                                    </c:forEach>
                                </select>
                            ...
                            <div class="col-md-2 position-relative">
                                ...
                                <select class="form-select" name="input-department" id="validationTooltip09" required>
                                    <c:forEach var="department" items="${employeeDepartmentList}">
                                        <option value="${department.getId()}" <c:if
                                                test="${employee.getEmployeeDepartment().getId()==department.getId()}"> selected </c:if>>${department.getName()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip10" class="form-label">Salary</label>
                                <input type="text" class="form-control" name="input-salary" id="validationTooltip10"
                                       required
                            ...
                            <div class="col-md-3 position-relative">
                                ...
                                <input type="text" class="form-control" name="input-email" id="validationTooltip11"
                                       required
