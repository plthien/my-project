                            ...
                            <table class="table align-items-center mb-0 " id="employeeTable" >
                                ...
                                <tr>
                                    <td class="align-middle p-3">
                                        <span class="text-secondary text-xs font-weight-bold">${employee.getId()}</span>
                                    </td>
                                    <td class="p-2">
                                        <div class="d-flex py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <td class="align-middle p-2 text-center">
                                        ...
                                        <a href="/employees?userAction=delete&id=${employee.getId()}" onclick="return confirm('Do you want to delete ${customer.getName()} ?')" class="text-secondary font-weight-bold text-xs badge badge-sm bg-gradient-light" data-toggle="tooltip" data-original-title="Delete Employee">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
