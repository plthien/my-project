    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Create New Employee</h6>
            </nav>
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        ...
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="date" class="form-control" name="input-birthday" id="validationTooltip02"
                                   required value="${employee.getBirthday()}">
                        </div>
                        <div class="col-md-2 position-relative">
                            ...
                            <select class="form-select" id="validationTooltip03" name="input-gender" required>
                                <option value="Male" <c:if test="${employee.getGender()=='Male'}">selected</c:if>>Male
                                </option>
                                <option value="Female" <c:if test="${employee.getGender()=='Female'}">selected</c:if>>
                                    Female
                                </option>
                            </select>
                        ...
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-personal-id" id="validationTooltip04"
                                   required value="${employee.getPersonalID()}">
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-phone-number" id="validationTooltip05"
                                   required value="${employee.getPhoneNumber()}">
                            <div class="text-danger">
                                ${phoneNumberMess}
                            </div>
                        </div>
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-address" id="validationTooltip06"
                                   required value="${employee.getAddress()}">
                        </div>
                        <div class="col-md-3 position-relative">
                            ...
                            <select class="form-select" name="input-degree" id="validationTooltip07" required>
                                <c:forEach var="degree" items="${employeeDegreeList}">
                                    <option value="${degree.getId()}"
                                            <c:if test="${degree.getId()==employee.getEmployeeDegree().getId()}">selected</c:if>>${degree.getName()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-md-3 position-relative">
                            ...
                            <select class="form-select" name="input-office" id="validationTooltip08" required>
                                <c:forEach var="office" items="${employeeOfficeList}">
                                    <option value="${office.getId()}"
                                            <c:if test="${office.getId()==employee.getEmployeeOffice().getId()}">selected</c:if>>${office.getName()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-md-3 position-relative">
                            ...
                            <select class="form-select" name="input-department" id="validationTooltip09" required>
                                <c:forEach var="department" items="${employeeDepartmentList}">
                                    <option value="${department.getId()}"
                                            <c:if test="${department.getId()==employee.getEmployeeDepartment().getId()}">selected</c:if>>${department.getName()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-md-3 position-relative">
