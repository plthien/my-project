    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Create New Facility</h6>
            </nav>
                ...
                <div class="card mb-4">
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-id" id="validationTooltip00" required
                        ...
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-usable-area" id="validationTooltip02"
                                   required value="${facility.getUsableArea()}">
                            <div class="text-danger">
                                ${usableAreaMess}
                            </div>
                        </div>
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-floors" id="validationTooltip03"
                                   required value="${facility.getFloors()}">
                            <div class="text-danger">
                                ${floorsMess}
                            </div>
                        </div>
                        <div class="col-md-2 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-customer-max" id="validationTooltip04"
                                   required value="${facility.getCustomerMax()}">
                            <div class="text-danger">
                                ${customerMaxMess}
                            </div>
                        </div>
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="text" class="form-control" name="input-cost" id="validationTooltip05" required
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <select class="form-select" name="input-rentingType" id="validationTooltip06" required>
                                <c:forEach var="rent" items="${rentingTypeList}">
                                    <option value="${rent.getId()}" <c:if
                                            test="${rent.getId() == facility.getRentingType().getId()}"> selected </c:if>>${rent.getName()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-md-3 position-relative">
                            ...
                            <select class="form-select" name="input-serviceType" id="validationTooltip07" required>
                                <c:forEach var="service" items="${serviceTypeList}">
                                    <option value="${service.getId()}"  <c:if
                                            test="${service.getId() == facility.getServiceType().getId()}"> selected </c:if>>${service.getName()}</option>
                                </c:forEach>
                            </select>
                        </div>
