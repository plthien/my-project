    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Edit Facility</h6>
            </nav>
                    ...
                    <form class="row g-3 needs-validation m-3" method="post">
                        <c:forEach var="facility" items="${facilityList}">
                            <div class="col-md-2 position-relative">
                                ...
                                <input type="text" class="form-control" name="input-id" id="validationTooltip00"
                                       readonly
                            ...
                            <div class="col-md-5 position-relative">
                                ...
                                <input type="text" class="form-control" name="input-name" id="validationTooltip01"
                                       required
                                       value="${facility.getName()}">
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip02" class="form-label">Usable Area</label>
                                <input type="text" class="form-control" name="input-usable-area"
                                       id="validationTooltip02" required
                                       value="${facility.getUsableArea()}">
                                <div class="text-danger">
                                        ${usableAreaMess}
                                </div>
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip03" class="form-label">Floors</label>
                                <input type="text" class="form-control" name="input-floors" id="validationTooltip03"
                                       required
                                       value="${facility.getFloors()}">
                                <div class="text-danger">
                                        ${floorsMess}
                                </div>
                            </div>
                            <div class="col-md-2 position-relative">
                                <label for="validationTooltip04" class="form-label">Customer Maximization</label>
                                <input type="text" class="form-control" name="input-customer-max"
                                       id="validationTooltip04" required
                                       value="${facility.getCustomerMax()}">
                                <div class="text-danger">
                                        ${customerMaxMess}
                                </div>
                            </div>
                            <div class="col-md-3 position-relative">
                                <label for="validationTooltip05" class="form-label">Cost</label>
                                <input type="text" class="form-control" name="input-cost" id="validationTooltip05"
                                       required
                                       value="${facility.getCost()}">
                                <div class="text-danger">
                                        ${costMess}
                                </div>
                            </div>
                            <div class="col-md-3 position-relative">
                                <label for="validationTooltip06" class="form-label">Renting Type</label>
                                <select class="form-select" name="input-rentingType" id="validationTooltip06" required>
                                    <c:forEach var="rentingType" items="${rentingTypeList}">
                                        <option value="${rentingType.getId()}" <c:if
                                                test="${facility.getRentingType().getId()==rentingType.getId()}"> selected </c:if>>${rentingType.getName()}</option>
                                    </c:forEach>
                                </select>

                            </div>
                            <div class="col-md-3 position-relative">
                                <label for="validationTooltip07" class="form-label">Service Type</label>
                                <select class="form-select" name="input-serviceType" id="validationTooltip07" required>
                                    <c:forEach var="serviceType" items="${serviceTypeList}">
                                        <option value="${serviceType.getId()}" <c:if
                                                test="${facility.getServiceType().getId()==serviceType.getId()}"> selected </c:if>>${serviceType.getName()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="col-12">
